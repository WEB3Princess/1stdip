                ...
                <div className="container header">
                    ...
                    <ul className="navbar-nav items mx-auto">
                        ...
                        {/* <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li className="nav-item"><a href="/blog" className="nav-link">Discord</a></li>
                                <li className="nav-item"><a href="/blog-single" className="nav-link">Telegram</a></li>
                                <li className="nav-item"><a href="/help-center" className="nav-link">Twitter</a></li>
                            </ul>
                        </li> */}
                        {/* <li className="nav-item dropdown">
